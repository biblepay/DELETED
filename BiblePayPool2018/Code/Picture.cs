...
namespace BiblePayPool2018
{
    ...
    public class Picture : USGDGui, IRequiresSessionState
    {
        ...
        public WebReply PictureAdd()
        {
            ...
            Edit ctlUpload = new Edit("Picture Add", Edit.GEType.UploadControl2, "btnSave", "Save", Sys);
        ...
        {
            string sql = "Select ID from Picture where Picture.Organization='" + USGDFramework.Shared.GuidOnly(Sys.Organization.ToString())
