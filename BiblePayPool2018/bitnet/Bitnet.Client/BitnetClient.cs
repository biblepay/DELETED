...
namespace Bitnet.Client
{
  public class BitnetClient : IBitnetClient
  {
    ...
    public object GetRawTransaction(string txid, string op)
    {

        object o;
       // o = InvokeMethod("getrawtransaction " + txid + " 1")["result"];
                o = InvokeMethod("getrawtransaction", txid, 1)["result"];
      ...
      public object GetBlockByBlockNumber2(long blocknum)
  {
      string s = "";
      object o = null;
          o = InvokeMethod("getblock",blocknum)["result"];
          s = (String)o.ToString();
    ...
    {
        return (float)InvokeMethod("getnetworkhashps")["result"];
    }
